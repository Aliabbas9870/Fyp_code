...
class HomeViewGirl extends StatefulWidget {
  const HomeViewGirl({super.key});

  @override
  State<HomeViewGirl> createState() => _HomeViewGirlState();
}

class _HomeViewGirlState extends State<HomeViewGirl> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        margin: EdgeInsets.only(left: 05, top: 15,right: 3),
        child: Padding(
